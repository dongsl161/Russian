...
public class FinishAnswer {
	...
	public FinishAnswer(String finishExaminationId, String questionId, String finishAnswerContent, int finishAnswerMark) {
		this.finishExaminationId = finishExaminationId;
		this.questionId = questionId;
		this.finishAnswerContent = finishAnswerContent;
		this.finishAnswerMark = finishAnswerMark;
	...
	public FinishAnswer(String finishExaminationId, String questionId, String finishAnswerContent) {
		this.finishExaminationId = finishExaminationId;
		this.questionId = questionId;
		this.finishAnswerContent = finishAnswerContent;
	}
